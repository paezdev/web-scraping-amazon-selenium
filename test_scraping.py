...
def test_scraping_non_empty_data():
    ...
    assert str(df.iloc[0]["Rating"]).strip(), "El rating del producto está vacío"
    assert str(df.iloc[0]["Number_of_Reviews"]).strip(), "El número de reseñas del producto está vacío"
